...
<%
String url = request.getContextPath()+"/api/apiEquipController/dataGrid";
%>
...
<body>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="equip_list_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td align="right" style="width: 180px;"><label>group(组，GP01等)：</label></td>
						<td><input name="group" type="text" class="span2" value="" /></td>
					</tr>
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#equip_list_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="equip_list_result"></div>
			<div>
				结果说明：1、json格式<br /> 
