...
<%
String url = request.getContextPath()+"/api/apiCommandController/dataGrid";
%>
...
<body>
	...
	$(function() {
		...
		$('#command_list_Form').form({
			...
			success : function(result) {
				parent.$.messager.progress('close');
				$("#command_list_result").text(result);
			}
		});
	});
</script>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<form id="command_list_Form" action="">
				<table align="center" width="90%" class="tablex">
					...
					<tr>
						<td align="right" style="width: 180px;"><label>equipType(分类，ET01等)：</label></td>
						<td><input name="equipType" type="text" class="span2" value="" /></td>
					</tr>
					...
					<tr>
						<td colspan="2" align="center"><input type="button"
							value="提交" onclick="javascript:$('#command_list_Form').submit();" /></td>
					</tr>
				</table>
			</form>
			<label>结果：</label>
			<div id="command_list_result"></div>
			<div>
				结果说明：1、json格式<br /> 
